{
  ...
  writeDefault = domain: key: value: "/usr/bin/defaults write ${domain} '${key}' ${writeValue value}";

  defaultsToList = domain: attrs: lib.mapAttrsToList (writeDefault domain) (lib.filterAttrs (_n: v: v != null) attrs);
